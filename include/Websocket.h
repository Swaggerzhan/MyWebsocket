//
// Created by swagger on 2020/12/21.
//

#ifndef MYWEBSOCKET2_WEBSOCKET_H
#define MYWEBSOCKET2_WEBSOCKET_H
...
public:
     ...
     *
     * @param frame_type
     * @param msg               msg's pointer
     * @param msg_length        msg's len
     * @param buffer            frame's pointer
     * @param buffer_size       frame's size
     * @return  buffer size
     */
...
#endif //MYWEBSOCKET2_WEBSOCKET_H
